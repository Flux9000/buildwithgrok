  ...
  tracks: [
    ...
    },
    {
      ...
      pages: [
        ...
        { id: "commands", href: "05-slash-commands.html", title: "Slash Commands", time: "30 min", blurb: "Commands that control Grok (start with /)", keywords: ["slash", "/help", "/compact", "commands", "/gboom", "easter egg"], verified: "2026-07-27", reviewEveryDays: 60 },
        ...
        { id: "sessions", href: "07-sessions-memory.html", title: "Sessions & Memory", time: "20 min", blurb: "Save chats, free space, optional memory", keywords: ["compact", "resume", "context", "memory"] },
        { id: "safety", href: "08-permissions-safety.html", title: "Permissions & Safety", time: "25 min", blurb: "Three safety layers, explained simply", keywords: ["sandbox", "permissions", "allow", "deny", "always-approve", "yolo", "ask mode", "auto mode", "os sandbox"], verified: "2026-07-20", reviewEveryDays: 60 },
    ...
    },
    {
      ...
      pages: [
        ...
        { id: "skills", href: "11-skills-plugins-hooks.html", title: "Skills, Plugins & Hooks", time: "25 min", blurb: "Saved playbooks, installable packs, and automatic scripts", keywords: ["skills", "plugins", "hooks", "SKILL.md"], verified: "2026-07-10", reviewEveryDays: 90 },
        { id: "plan", href: "12-plan-mode.html", title: "Plan Mode", time: "15 min", blurb: "Approve a plan before big code changes", keywords: ["plan", "design", "approve plan"], verified: "2026-07-10", reviewEveryDays: 90 },
        { id: "agents", href: "13-subagents.html", title: "Subagents & Personas", time: "15 min", blurb: "Helper chats that research or work in parallel", keywords: ["subagent", "explore", "parallel", "personas"], verified: "2026-07-10", reviewEveryDays: 90 },
        { id: "mcp", href: "14-mcp.html", title: "MCP Integrations", time: "20 min", blurb: "Connect Grok to other apps you trust", keywords: ["mcp", "model context protocol", "integrations", "servers", "tools servers"], verified: "2026-07-18", reviewEveryDays: 60 },
        { id: "auto", href: "15-automation.html", title: "Headless & Agent Mode", time: "25 min", blurb: "Run Grok from scripts or inside your editor", keywords: ["headless", "ci", "acp", "max-turns", "agent mode", "yolo"], verified: "2026-07-18", reviewEveryDays: 60 },
        { id: "workflows", href: "16-workflows-goals.html", title: "Workflows, Goals & Loops", time: "20 min", blurb: "Timers, long goals, and multi-agent runs", keywords: ["workflow", "goal", "loop", "deep-research", "rhai"], verified: "2026-07-18", reviewEveryDays: 60 },
        { id: "dashboard", href: "23-dashboard-multisession.html", title: "Dashboard & Multi-Session", time: "15 min", blurb: "Several Grok chats at once—kept organized", keywords: ["dashboard", "multi-session", "worktree", "parallel chats"], verified: "2026-07-18", reviewEveryDays: 60 },
      ],
    },
    {
      id: "mastery",
